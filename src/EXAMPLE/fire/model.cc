...
bool Model::initialize(ID3D11Device* device, const char* modelFilename, const WCHAR* textureFilename1, 
...
bool Model::loadTexture(ID3D11Device* device, const WCHAR* textureFilename1, 
						const WCHAR* textureFilename2, const WCHAR* textureFilename3)
{
	bool result;
